...
<html>
    ...
    <body>
        ...
        <table cellpadding="15" align="center" style="background-color:  #FFE600;">
            <tr>
                <td width="750" align="left">File name:</td>
                <td width="200" align="center">Download:</td>
            </tr>
        </table>

        <%--try-catch block to retrieve filepath, from the adminfiles table--%>
        <%
        try {
            ...
            String query = "Select filepath from adminfiles_docs where username='" + user + "'";
        ...
        <table cellpadding="15" align="center">
            <tr style="background-color: #ffffcc;">
                <td width="750" align="left"><%=file%></td>
